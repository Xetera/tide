...
export interface HTMLevateActionDict<T> extends BaseActionDict<T> {
  ...
  ColonTransform_text?: (this: NonterminalNode, arg0: TerminalNode, arg1: TerminalNode) => T;
  ColonTransform_attr?: (this: NonterminalNode, arg0: TerminalNode, arg1: TerminalNode, arg2: TerminalNode, arg3: NonterminalNode, arg4: TerminalNode) => T;
  ColonTransform_data?: (this: NonterminalNode, arg0: TerminalNode, arg1: TerminalNode, arg2: TerminalNode, arg3: NonterminalNode, arg4: TerminalNode) => T;
  ColonTransform_exists?: (this: NonterminalNode, arg0: TerminalNode, arg1: TerminalNode) => T;
...
export interface HTMLevateSemantics extends Semantics {
  addOperation<T>(name: string, actionDict: HTMLevateActionDict<T>): this;
  extendOperation<T>(name: string, actionDict: HTMLevateActionDict<T>): this;
  addAttribute<T>(name: string, actionDict: HTMLevateActionDict<T>): this;
  extendAttribute<T>(name: string, actionDict: HTMLevateActionDict<T>): this;
}

export interface HTMLevateGrammar extends Grammar {
  createSemantics(): HTMLevateSemantics;
  extendSemantics(superSemantics: HTMLevateSemantics): HTMLevateSemantics;
}

declare const grammar: HTMLevateGrammar;
